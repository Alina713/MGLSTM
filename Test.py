...
from Data_Loader import load_traindata0
...
def eval_model():
    ...
    data_loader_train = TrainDataValLoader(args.train_file0, args.train_file, args.batch_size)
...
if __name__ == '__main__':
    ...
    setup_logger('GRLSTM_test_v5.log')
    eval_model()
